...
//可以看到，SkbContainer负责了对键盘的切换。一个SoftKeyboardView  可以对应多个SoftKeyboard
public class SkbContainer extends RelativeLayout implements OnTouchListener {
    ...
    //更新键盘布局
    //一个SoftKeyboardView  可以对应多个SoftKeyboard
